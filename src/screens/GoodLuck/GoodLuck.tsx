...
import { FinishButton } from '../../components/templates/QuestionList/styles';

import { GoodLuckContainer, GoodLuckReminder } from './styles';
    ...
    <GoodLuckContainer>
      ...
      {reminders.map((r) => (
        <GoodLuckReminder>
          ...
          <Typography variant="title-3">{r.title}</Typography>
        </GoodLuckReminder>
      ))}
